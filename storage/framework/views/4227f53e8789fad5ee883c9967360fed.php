...
<?php $component = App\View\Components\AdminLayout::resolve(['title' => 'Reset Sistem'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-2 border-red-300">
                ...
                <form action="<?php echo e(route('admin.reset.truncate')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Password Konfirmasi</label>
                        <input type="password" 
...
<?php /**PATH C:\project\bmtnu\resources\views/admin/reset.blade.php ENDPATH**/ ?>