...
<head>
    ...
    <title>{{ $title }} - {{ config('app.name', 'BMT Lucky Draw') }}</title>
                ...
                <div class="p-4">
                    ...
                    <nav class="space-y-1.5 pb-6">
                        <a href="{{ route('admin.dashboard') }}" 
                           class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-green-100/90 hover:bg-white/10 hover:text-white' }}">
                        ...
                        @if(auth()->user()->isAdmin())
                            <a href="{{ route('admin.pesertas.trash') }}" 
                               class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.pesertas.trash') ? 'bg-red-500/20 text-white shadow-lg backdrop-blur-sm border border-red-400/30' : 'text-red-200/90 hover:bg-red-500/10 hover:text-white' }}">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.winners') }}" 
                           class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.winners') ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-green-100/90 hover:bg-white/10 hover:text-white' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.profile.edit') }}" 
                           class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.profile.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-green-100/90 hover:bg-white/10 hover:text-white' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.activity-logs') }}" 
                           class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.activity-logs') ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-green-100/90 hover:bg-white/10 hover:text-white' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @if(auth()->user()->isAdmin())
                            ...
                            <a href="{{ route('admin.settings.edit') }}" 
                               class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.settings.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-green-100/90 hover:bg-white/10 hover:text-white' }}">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('admin.users.index') }}" 
                               class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-green-100/90 hover:bg-white/10 hover:text-white' }}">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                                </svg>
                            ...
                            <a href="{{ route('admin.backups.index') }}" 
                               class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.backups.*') ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-green-100/90 hover:bg-white/10 hover:text-white' }}">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('admin.reset') }}" 
                               class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.reset*') ? 'bg-red-500/20 text-white shadow-lg backdrop-blur-sm border border-red-400/30' : 'text-red-200/90 hover:bg-red-500/10 hover:text-white' }}">
                                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="{{ route('admin.import-info') }}" 
                           class="group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 {{ request()->routeIs('admin.import-info') ? 'bg-white/20 text-white shadow-lg backdrop-blur-sm' : 'text-green-100/90 hover:bg-white/10 hover:text-white' }}">
                            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                            </svg>
            ...
            <div class="flex-shrink-0 w-full p-4 border-t border-white/10 bg-green-900/50 backdrop-blur-sm">
                <div class="flex items-center space-x-3 mb-4 pb-4 border-b border-white/10">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-green-200/70 truncate">{{ auth()->user()->email }}</p>
                    </div>
                </div>
                <div class="mb-3">
                    <span class="inline-flex items-center px-2.5 py-1 rounded-lg text-xs font-medium {{ auth()->user()->role === 'admin' ? 'bg-blue-500/20 text-blue-200 border border-blue-400/30' : 'bg-green-500/20 text-green-200 border border-green-400/30' }}">
