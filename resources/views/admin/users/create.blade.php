<x-admin-layout title="Tambah Akun">
    <div class="max-w-2xl mx-auto">
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-2">Buat akun admin baru untuk mengakses sistem</p>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select name="role" 
                                required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500">
                            <option value="operator" {{ old('role') === 'operator' ? 'selected' : '' }}>Operator (Hanya Import & Lihat Pemenang)</option>
